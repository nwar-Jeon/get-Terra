...
class MainActivity : AppCompatActivity(), Presenter.MainView {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<CustomButton>(R.id.login_signUp_tv).let {
        ...
        findViewById<CustomButton>(R.id.login_login_tv).let {
            it.setOnColor(ContextCompat.getColor(this,R.color.main), Color.WHITE)
            it.setOnClickListener {
                presenter.tryLogin(id.text?.toString(),pw.text?.toString())
            }
        }
        findViewById<View>(R.id.main_top_v).startAnimation(AnimationUtils.loadAnimation(this,R.anim.head_showin_anim))
    }
    ...
    override fun loginResult(bool: Boolean) {
        if(bool){
            ...
            findViewById<View>(R.id.main_top_v).startAnimation(AnimationUtils.loadAnimation(this,R.anim.head_showout_anim))
